      ...
      <Modal isOpen={showAboutArc} onClose={() => setShowAboutArc(false)} title="Arc FAUCET">
         <div className="bg-yellow-900/20 border-l-4 border-yellow-600 p-4">
            <p className="text-yellow-300/80 leading-relaxed text-sm">
               At the end of your game session, a background transaction 
               records your final score to the blockchain. 
               A micro-fee is calculated proportionally based on the number 
               of lines you cleared (simulating network usage).
            </p>
         </div>
         <a 
